 ...
 * 
 */
@WebServiceClient(name = "Bank_Service", targetNamespace = "http://bsr.com/services/bank", wsdlLocation = "http://localhost:8080/ws/bank.wsdl")
    ...
    extends Service
{
    ...
    private final static QName BANKSERVICE_QNAME = new QName("http://bsr.com/services/bank", "Bank_Service");
     ...
     */
    @WebEndpoint(name = "Bank_Port")
    public BankPortType getBankPort() {
        return super.getPort(new QName("http://bsr.com/services/bank", "Bank_Port"), BankPortType.class);
    }
    ...
    public BankPortType getBankPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://bsr.com/services/bank", "Bank_Port"), BankPortType.class, features);
    }
